...
mod imp {
    ...
    pub struct TrucoWindow {
        ...
        #[template_child]
        pub banner_revealer: TemplateChild<gtk::Revealer>,
        #[template_child]
        pub lbl_banner: TemplateChild<gtk::Label>,
        #[template_child]
        pub btn_banner_close: TemplateChild<gtk::Button>,
        #[template_child]
...
impl TrucoWindow {
    ...
    pub fn banner_revealer(&self) -> gtk::Revealer {
        self.imp().banner_revealer.get()
    }
    pub fn lbl_banner(&self) -> gtk::Label {
        self.imp().lbl_banner.get()
    }
    pub fn btn_banner_close(&self) -> gtk::Button {
        self.imp().btn_banner_close.get()
    }
    ...
    pub fn btn_leave_match(&self) -> gtk::Button {
        self.imp().btn_leave_match.get()
    }
    pub fn trick_end_overlay(&self) -> gtk::Overlay {
        self.imp().trick_end_overlay.get()
    }
    pub fn lbl_trick_emoji(&self) -> gtk::Label {
        self.imp().lbl_trick_emoji.get()
    }
    pub fn lbl_trick_text(&self) -> gtk::Label {
        self.imp().lbl_trick_text.get()
    }
}
