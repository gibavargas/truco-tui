...
/* package truco-tui/cmd/truco-core-ffi */
...
extern char* TrucoCoreSnapshotJSON(uintptr_t handle);
extern char* TrucoCoreVersionsJSON(void);
extern void TrucoCoreFreeString(char* ptr);
