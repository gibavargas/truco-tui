...
## 2025-03-11 - Chat Input Missing ARIA Label
**Learning:** Compact chat inputs relying only on placeholders without visible labels are inaccessible to screen readers.
**Action:** Always add `aria-label` matching the placeholder or purpose when a visible `<label>` is omitted to save space.
