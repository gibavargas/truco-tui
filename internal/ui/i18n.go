...
var translations = map[locale]map[string]string{
	localePTBR: {
		...
		"host_transport_prompt":                "Transporte (Enter auto, 1 direto TCP/TLS, 2 Tailnet, 3 Relay QUIC v2)",
		...
		"host_commands":                        "Comandos: chat <msg> | start | vote <n> | invite <n> | refresh | back",
		"host_prompt":                          "host>",
		...
		"join_commands":                        "Comandos: chat <msg> | vote <n> | refresh | back",
		"join_prompt":                          "join>",
		...
		"tab_chat":                             "chat",
		"tab_log":                              "log",
		"panel_chat_desc_offline":              "CHAT (offline): mensagens locais da sessao.",
		"panel_chat_desc_online":               "CHAT (online): mensagens da mesa conectada.",
		...
		"panel_actions_prefix":                 "Ações:",
		"panel_actions_wait_turn":              "aguarde sua vez",
		"panel_actions_match_over":             "partida encerrada",
		"panel_log_empty":                      "LOG DA PARTIDA: sem eventos recentes.",
		"ui_turn_short":                        "vez",
		...
		"help_face_down_short":                 "armar virada",
		"help_face_down_armed_short":           "virada armada",
		...
		"terminal_too_small_title":             "MESA MUITO PEQUENA",
		"terminal_too_small_desc":              "Por favor, redimensione o terminal para pelo menos %dx%d.\nDimensões atuais: %dx%d.",
	},
	localeENUS: {
		...
		"host_transport_prompt":                "Transport (Enter auto, 1 direct TCP/TLS, 2 Tailnet, 3 Relay QUIC v2)",
		...
		"host_commands":                        "Commands: chat <msg> | start | vote <n> | invite <n> | refresh | back",
		"host_prompt":                          "host>",
		...
		"join_commands":                        "Commands: chat <msg> | vote <n> | refresh | back",
		"join_prompt":                          "join>",
		...
		"tab_chat":                             "chat",
		"tab_log":                              "log",
		"panel_chat_desc_offline":              "CHAT (offline): local session messages.",
		"panel_chat_desc_online":               "CHAT (online): connected table messages.",
		...
		"panel_actions_prefix":                 "Actions:",
		"panel_actions_wait_turn":              "waiting for your turn",
		"panel_actions_match_over":             "match finished",
		"panel_log_empty":                      "MATCH LOG: no recent events.",
		"ui_turn_short":                        "turn",
		...
		"help_face_down_short":                 "arm face-down",
		"help_face_down_armed_short":           "face-down armed",
		...
		"terminal_too_small_title":             "TERMINAL TOO SMALL",
		"terminal_too_small_desc":              "Please resize your terminal to at least %dx%d.\nCurrent dimensions: %dx%d.",
	},
}
