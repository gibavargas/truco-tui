        ...
        <article class="surface-card form-card primary-form-card">
          ...
          <form data-api-action="startGame" data-form-id="startGame">
            <div class="field-grid">
              <label for="startGame-name">
                <span>${escapeHtml(t("setup_name"))}</span>
                <input id="startGame-name" name="name" type="text" value="${escapeHtml(state.playerName || t("name_placeholder"))}" autocomplete="off" required>
              </label>
              <label for="startGame-numPlayers">
                <span>${escapeHtml(t("setup_players"))}</span>
                <select id="startGame-numPlayers" name="numPlayers">
        ...
        <article class="surface-card form-card online-form-card">
          ...
          <div class="online-flow-grid">
            <form class="mode-form" data-api-action="startOnlineHost" data-form-id="startOnlineHost">
              ...
              <div class="field-grid">
                <label for="startOnlineHost-name">
                  <span>${escapeHtml(t("setup_name"))}</span>
                  <input id="startOnlineHost-name" name="name" type="text" value="${escapeHtml(state.playerName || t("name_placeholder"))}" autocomplete="off" required>
                </label>
                <label for="startOnlineHost-numPlayers">
                  <span>${escapeHtml(t("setup_players"))}</span>
                  <select id="startOnlineHost-numPlayers" name="numPlayers">
                    <option value="2">2</option>
                    <option value="4">4</option>
                  </select>
                </label>
              </div>
              <label for="startOnlineHost-relay">
                <span>${escapeHtml(t("setup_relay"))}</span>
                <input id="startOnlineHost-relay" name="relay_url" type="text" value="${escapeHtml(state.relayURL)}" placeholder="${escapeHtml(t("relay_placeholder"))}" autocomplete="off">
              </label>
            ...
            <form class="mode-form" data-api-action="joinOnline" data-form-id="joinOnline">
              ...
              <div class="field-grid">
                <label for="joinOnline-name">
                  <span>${escapeHtml(t("setup_name"))}</span>
                  <input id="joinOnline-name" name="name" type="text" value="${escapeHtml(state.playerName || t("name_placeholder"))}" autocomplete="off" required>
                </label>
                <label for="joinOnline-key">
                  <span>${escapeHtml(t("setup_invite"))}</span>
                  <input id="joinOnline-key" name="key" type="text" autocomplete="off" required>
                </label>
              </div>
              <label for="joinOnline-role">
                <span>${escapeHtml(t("setup_role"))}</span>
                <select id="joinOnline-role" name="role">
      ...
      <div class="lobby-side-stack">
        <article class="surface-card chat-card">
          ...
          <form class="chat-form" data-api-action="sendChat" data-form-id="sendChat">
            <input name="message" type="text" autocomplete="off" placeholder="${escapeHtml(t("chat_placeholder"))}" aria-label="${escapeHtml(t("lobby_chat"))}" required>
