          ...
          <form data-api-action="startGame" data-form-id="startGame">
            <div class="field-grid">
              <label>
                ...
                <input name="name" aria-label="${escapeHtml(t('setup_name'))}" type="text" value="${escapeHtml(state.playerName || t("name_placeholder"))}" autocomplete="off">
              </label>
              <label>
              ...
              <details class="details-advanced" data-details-key="advanced-relay">
                ...
                <div>
                  <label>
                    ...
                    <input name="relay_url" aria-label="${escapeHtml(t('setup_relay'))}" type="text" value="${escapeHtml(state.relayURL)}" placeholder="${escapeHtml(t("relay_placeholder"))}" autocomplete="off" title="${escapeHtml(t("setup_relay_hint"))}">
                  </label>
                </div>
              </details>
      ...
      <div class="lobby-side-stack">
        <article class="surface-card chat-card">
          ...
          <form class="chat-form" data-api-action="sendChat" data-form-id="sendChat">
            <input name="message" aria-label="${escapeHtml(t('chat_placeholder'))}" type="text" autocomplete="off" placeholder="${escapeHtml(t("chat_placeholder"))}">
