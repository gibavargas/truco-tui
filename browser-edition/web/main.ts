        ...
        <article class="surface-card form-card primary-form-card">
          ...
          <form data-api-action="startGame" data-form-id="startGame">
            <div class="field-grid">
              <label for="offline-name">
                <span>${escapeHtml(t("setup_name"))}</span>
                <input id="offline-name" name="name" type="text" value="${escapeHtml(state.playerName || t("name_placeholder"))}" required autocomplete="off">
              </label>
              <label for="offline-players">
                <span>${escapeHtml(t("setup_players"))}</span>
                <select id="offline-players" name="numPlayers">
          ...
          <div class="online-flow-grid">
            <form class="mode-form" data-api-action="startOnlineHost" data-form-id="startOnlineHost">
              ...
              <div class="field-grid">
                <label for="host-name">
                  <span>${escapeHtml(t("setup_name"))}</span>
                  <input id="host-name" name="name" type="text" value="${escapeHtml(state.playerName || t("name_placeholder"))}" required autocomplete="off">
                </label>
                <label for="host-players">
                  <span>${escapeHtml(t("setup_players"))}</span>
                  <select id="host-players" name="numPlayers">
                    <option value="2">2</option>
                    <option value="4">4</option>
                  </select>
                </label>
              </div>
              <label for="host-relay">
                <span>${escapeHtml(t("setup_relay"))}</span>
                <input id="host-relay" name="relay_url" type="text" value="${escapeHtml(state.relayURL)}" placeholder="${escapeHtml(t("relay_placeholder"))}" autocomplete="off">
              </label>
            ...
            <form class="mode-form" data-api-action="joinOnline" data-form-id="joinOnline">
              ...
              <div class="field-grid">
                <label for="join-name">
                  <span>${escapeHtml(t("setup_name"))}</span>
                  <input id="join-name" name="name" type="text" value="${escapeHtml(state.playerName || t("name_placeholder"))}" required autocomplete="off">
                </label>
                <label for="join-key">
                  <span>${escapeHtml(t("setup_invite"))}</span>
                  <input id="join-key" name="key" type="text" required autocomplete="off">
                </label>
              </div>
              <label for="join-role">
      ...
      <div class="lobby-side-stack">
        <article class="surface-card chat-card">
          ...
          <form class="chat-form" data-api-action="sendChat" data-form-id="sendChat">
            <input name="message" type="text" aria-label="${escapeHtml(t("chat_placeholder"))}" required autocomplete="off" placeholder="${escapeHtml(t("chat_placeholder"))}">
